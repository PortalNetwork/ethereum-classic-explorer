import { getEthereumClassicProvider, getEthereumClassicRegistrarAddress } from './web3Service';
...
const setWeb3Provider = () => {
  web3.setProvider(new web3.providers.HttpProvider(getEthereumClassicProvider(process.env.ECNS_NETWORK)));
  registrar = new Registrar(web3, getEthereumClassicRegistrarAddress(process.env.ECNS_NETWORK));
}
